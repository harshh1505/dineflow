  ...
  const plans = [
    {
      ...
      features: [
        { text: 'Up to 50 physical dining tables', included: true },
        { text: '₹25,000 custom onboarding & setup', included: true },
        { text: 'Zero monthly commissions', included: true },
        { text: 'Unlimited digital menu items', included: true },
        { text: 'Full color and theme branding setup', included: true },
        { text: 'Real-time kitchen order dashboard', included: true },
        { text: '5 manager and staff access accounts', included: true },
        { text: 'Export menu to CSV / Excel sheet', included: true },
        { text: 'Customer reviews & feedback center', included: true },
        { text: 'Priority WhatsApp & call support', included: true },
        { text: 'Custom domain mapping add-on', included: false },
    ...
    },
    {
      ...
      features: [
        { text: 'Unlimited physical dining tables', included: true },
        { text: '₹25,000 custom onboarding & setup', included: true },
        { text: '2% revenue share on monthly sales', included: true },
        { text: 'Unlimited digital menu items', included: true },
        { text: 'Full color and theme branding setup', included: true },
        { text: 'Real-time kitchen order dashboard', included: true },
        { text: 'Unlimited staff and waiter logins', included: true },
        { text: 'Customer reviews & feedback center', included: true },
        { text: 'Custom domain branding included', included: true },
        { text: 'Advanced sales & CRM analytics', included: true },
        { text: 'Standard POS & payment gateway APIs', included: true },
        { text: 'Priority WhatsApp & call support', included: true },
      ]
    },
    {
      ...
      features: [
        ...
        { text: '₹25,000 custom onboarding & setup', included: true },
        { text: 'Zero monthly commissions', included: true },
        { text: 'Unlimited menu items & multi-menus', included: true },
        { text: 'Custom branding & style template design', included: true },
        { text: 'Dedicated account onboarding manager', included: true },
        { text: 'Custom domain branding included', included: true },
        { text: 'Advanced sales & visual CRM analytics', included: true },
        { text: 'Table occupancy & live staff call feed', included: true },
        { text: 'Standard POS & payment gateway APIs', included: true },
        { text: 'SLA-backed 4-hour priority support', included: true },
        { text: 'Unlimited staff and waiter logins', included: true },
      ]
    }
  ];
